...
> [!IMPORTANT]
> 본 강의 수강을 위해 필요한 준비물은 스마트폰과 학교 계정의 AI입니다.
...
| BYOD(Bring Your Own Device) 실습 + 검토 | 15′ | **스마트폰으로 직접** — 매주 지참 |
| 강의 Ⅲ — 심화·확장 | 30′ | 심화 + 정리 |
...
1. 스마트폰에서 **gemini.google.com** 접속 (또는 Gemini 앱)
2. **학교 Google 계정(@dankook.ac.kr)** 으로 로그인
