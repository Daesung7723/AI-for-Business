...
> [!IMPORTANT]
> 본 강의 수강을 위해 필요한 준비물은 **개인 기기**(스마트폰·태블릿·노트북 중 편한 것)와 **AI 계정**입니다. 이미 사용 중인 AI 계정이 있으면 그대로 쓰고, 없으면 학교 제공 무료 계정(Gemini)을 사용합니다.
...
다만 **이미 사용 중인 AI 계정**(개인 Gemini·ChatGPT 등)이 있다면 그것을 계속 써도 됩니다. 시연은 학교 계정 Gemini로 진행하므로 화면 구성이 조금 다를 수 있다는 점만 감안하면 됩니다. 기기도 마찬가지입니다 — 스마트폰·태블릿·노트북 중 편한 것을 매주 가져오면 됩니다.
...
| 구간 | 시간 | 내용 |
|---|:---:|---|
| 도입 + 사례 공유 | 15′ | 로테이션 발표(가볍게) |
| 강의 Ⅰ | 45′ | 그 주의 개념 |
| 강의 Ⅱ + AI 시연 | 45′ | 개념의 실연과 검증 |
| BYOD(Bring Your Own Device) 실습 + 검토 | 15′ | **개인 기기로 직접**(스마트폰·태블릿·노트북 중 편한 것) — 매주 지참 |
| 강의 Ⅲ — 심화·확장 | 30′ | 심화 + 정리 |
...
1. 개인 기기에서 **gemini.google.com** 접속 (또는 Gemini 앱)
