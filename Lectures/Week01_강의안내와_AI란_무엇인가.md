...
| 구분 | 도구 | 비고 |
|---|---|---|
| **권장 (학교 제공)** | Gemini + Gemini Notebook(구 NotebookLM) | **학교 제공 Google 계정(@dankook.ac.kr)** — 전원 보유·무료·데이터 보호. 시연은 이 계정으로 진행 |
...
| 실습 + 검토 | **강의실 PC로 직접** — 개인 기기(스마트폰·태블릿·노트북) 사용도 가능 |
| 강의 Ⅲ — 심화·확장 | 심화 + 정리 |

주차별 강의자료는 **수업 전에 GitHub에 게시**합니다. 별도 교재가 없는 과목이므로 이 자료를 예습·복습 자료로 읽고, 수업 중 추가로 설명한 내용은 각자 필기해 두시기 바랍니다. 시연의 검증 결과와 지문 비판 해설은 접혀 있으니, 먼저 스스로 판단해 본 뒤 펼쳐 확인하시기 바랍니다.
...
1. 과목 구조(교수 시연 + 실습 + 사례 공유·2-Track 과제)와 최종 제출물(분석보고서)을 인지한다.
...
> **"일반 AI"라는 용어에 주의**
>
> "일반 AI"는 두 가지 뜻으로 쓰입니다. ① 일상에서는 추천·예측처럼 정해진 작업을 하는 **기존 AI**를 가리키고, ② 뉴스·학계에서는 **AGI(일반 인공지능, Artificial General Intelligence)** — 인간처럼 분야를 가리지 않고 스스로 배우고 판단하는 AI — 를 뜻합니다. AGI에 도달했는가는 2026년 9월 현재 논쟁 중인 사안입니다 — 한 개발사는 "시대에 들어섰다"고 발표했고, 독립 평가기관은 이를 인정하지 않았습니다(2주 1.3에서 다룹니다).
>
...
| 날짜 | 내용 |
|:--:|------|
| 2026-09-23 | §3 「AI 발전 3단계」 표 — 생성형 AI 시기(「2017(기술 등장)\~2022(대중화)\~」)의 물결표가 취소선으로 처리되어 연도가 바뀌어 보이던 표시 오류를 수정했습니다. **내용은 바뀌지 않았습니다.** |
| 2026-09-01 | 최초 게시 |
